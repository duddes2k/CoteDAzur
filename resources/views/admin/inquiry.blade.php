...
<div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Inquiries</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Inquiries</a>
                </li>
                <li class="breadcrumb-item active"><strong>All</strong>
                </li>
              </ol>
            </div>
          </div>
...
<script src="{{ asset('vendors/js/tables/jquery.dataTables.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('vendors/js/tables/datatable/dataTables.bootstrap4.min.js') }}"
...
<script>
  ...
  $(document).ready(function(){
    ...
    ********************************************/
    ...
    $("div.toolbar").html('<table><tr><td><strong>Sales Date Range</strong></td><td><td><div class="input-group"><input type="text" class="form-control daterange" readonly><div class="input-group-append"><span class="input-group-text"><span class="la la-calendar"></span></span></div></div></td></tr></table>');
    ...
    $('#category_id').on('change', function(e){
        ...
        $.ajax({
            url: "{{ route('inventories.itemcode') }}",
            headers: {
